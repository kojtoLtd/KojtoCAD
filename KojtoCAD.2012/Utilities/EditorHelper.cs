...
{
    /// <summary>
    /// Prompts for the active document ( MdiActiveDocument )
    /// </summary>
    public class EditorHelper : IEditorHelper
    {
        ...
        public Matrix3d CurrentUcs
        {
            get { return _editor.CurrentUserCoordinateSystem; }
            set { _editor.CurrentUserCoordinateSystem = value; }
        }

...
namespace KojtoCAD.Attribute
{
    public partial class BaseForm : Form
    {
        ...
        public BaseForm(ref ArrayList Blocks, ref ArrayList BlocksWithLessThanThreeAttribute)
        {
        ...
        {
            if (textBoxExcelFile.Text.Length< 4)
            {
            ...
            if (comboBoxExistAttribute.Text.Length < 1)
            {
            ...
            if (comboBoxNotExist.Text.Length < 1)
            {
            ...
            if (comboBoxSheets.Text.Length < 1)
            {
        ...
        private void buttonExcelFileBrowse_Click(object sender, EventArgs e)
        {
        ...
        private void buttonOutFolderBrowse_Click(object sender, EventArgs e)
        {
        ...
        private void comboBoxExistAttribute_DrawItem(object sender, DrawItemEventArgs e)
        {         
        ...
        private void comboBoxNotExist_DrawItem(object sender, DrawItemEventArgs e)
        {
            Graphics g = e.Graphics;
            Rectangle rect = e.Bounds;
            if (e.Index >= 0)
